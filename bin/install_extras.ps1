...
start-process powershell -ArgumentList '-wait -noexit -command kali.exe' | Out-Null
start-process powershell -ArgumentList "-wait -noexit -command wsl.exe -d kali-linux --exec '../Scripts/configure_wsl.sh'" | Out-Null