function containers_linux {
    ...
    do {
        ...
        switch ($choice) {
            ...
            3 {
                Start-Process pwsh "-File", "container_centos.ps1"
            }
            4 {
                Start-Process pwsh "-File", "container_rhel.ps1"
            }
            5 {
                Start-Process pwsh "-File", "container_kali.ps1"
            }
            6 {
                Start-Process pwsh -File "../Scripts/Linux/container_blackarch.ps1"
            }
            7 {
